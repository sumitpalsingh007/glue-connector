...
class connectors.Writer implements DataSourceWriter {
    private DataSourceOptions options;

    connectors.Writer(DataSourceOptions options) {
        this.options = options;
    }

    @Override
    public DataWriterFactory<InternalRow> createWriterFactory() {
        return new connectors.JavaSimpleDataWriterFactory(options);
    }
...
class connectors.JavaSimpleDataWriterFactory implements DataWriterFactory<InternalRow> {
    private String bucket, keyPrefix;

    connectors.JavaSimpleDataWriterFactory(DataSourceOptions options) {
        bucket = options.get("bucket").get();
    ...
    public DataWriter<InternalRow> createDataWriter(int partitionId, long taskId, long epochId) {
        return new connectors.JavaSimpleDataWriter(partitionId, taskId, epochId, bucket, keyPrefix);
    }
}

class connectors.JavaSimpleDataWriter implements DataWriter<InternalRow> {
    ...
    connectors.JavaSimpleDataWriter(int partitionId, long taskId, long epochId, String bucket, String keyPrefix) {
